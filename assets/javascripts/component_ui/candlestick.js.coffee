...
COLOR_ON =
  candlestick:
    color: 'rgba(255, 105, 57, 0.35)'
    upColor: 'rgba(132, 247, 102, 0.35)'
    lineColor: 'rgba(255, 105, 57, 0.85)'
    upLineColor: 'rgba(132, 247, 102, 0.85)'
  close:
    color: null
  ...
  @initHighStock = (data) ->
    ...
    Highcharts.setOptions
      chart:
        style:
          fontSize: "16px"
          fontFamily: "MonoFont, Menlo, Monaco, Consolas, monospace"
